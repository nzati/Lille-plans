...
Leaflet et Panzoom sont embarqués dans `www/vendor/` (copiés depuis `node_modules`) : les plans schématiques fonctionnent hors connexion, seul le fond de carte des bus nécessite Internet.
